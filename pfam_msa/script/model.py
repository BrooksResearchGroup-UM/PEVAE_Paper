...
class MSA_Dataset(Dataset):
    def __init__(self, seq_msa_binary, seq_weight):
    ...
    def __getitem__(self, idx):
        return self.seq_msa_binary[idx, :], self.seq_weight[idx]

class VAE(nn.Module):
    def __init__(self, dim_latent_vars, dim_msa_vars, num_hidden_units):
